/*
  ...
  - You are about to drop the column `statusCode` on the `Project` table. All the data in the column will be lost.
  - You are about to drop the column `statusRefId` on the `Project` table. All the data in the column will be lost.

*/
-- DropForeignKey
ALTER TABLE "public"."Project" DROP CONSTRAINT "Project_statusRefId_fkey";
...
ADD COLUMN     "projectStatusRefId" INTEGER;
...
-- AddForeignKey
ALTER TABLE "public"."Project" ADD CONSTRAINT "Project_projectStatusRefId_fkey" FOREIGN KEY ("projectStatusRefId") REFERENCES "public"."ProjectStatusRef"("id") ON DELETE SET NULL ON UPDATE CASCADE;
